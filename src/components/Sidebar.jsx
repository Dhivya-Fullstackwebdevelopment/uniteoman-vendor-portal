...
//   { key: 'live-map', icon: 'credit-card', label: 'Live Map' },
//   { key: 'reviews', icon: 'chart-bar', label: 'Reviews' },
//   { key: 'analytics', icon: 'chart-bar', label: 'Analytics' },
//   { key: 'notifications', icon: 'chart-bar', label: 'Notifications' },
...
//           <div className="font-semibold text-xs leading-none text-white truncate">Vendor User</div>
//           <div className="font-normal text-[10px] leading-none text-white/35 mt-[3px]">Vendor User</div>
//         </div>
//         <svg
//           onClick={onLogout}
//           title="Log out"
...
const Sidebar = ({ activePage = 'dashboard', onNavigate = () => { }, onLogout = () => { }, vendorName = 'Mohammed Al-Balushi', credits = 240, isOnline = true }) => {
  return (
    <div className="w-[232px] bg-[#0A0A0F] flex flex-col flex-shrink-0 overflow-y-auto">
      {/* Logo */}
      <div className="px-5 pt-5 pb-4">
        ...
        {/* Vendor mini profile chip */}
        <div className="flex items-center gap-2 mt-3 bg-white/5 rounded-xl px-2.5 py-2">
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center font-bold text-[11px] text-white flex-shrink-0">
            {vendorName.charAt(0)}
          </div>
          <div className="min-w-0">
            <div className="font-semibold text-[11px] leading-none text-white truncate">
              {vendorName}
            </div>
            <div className="flex items-center gap-1 mt-1">
              <span className="font-normal text-[10px] leading-none text-white/40">
                {credits} credits
              </span>
              <span className="text-white/20 text-[10px]">·</span>
              <span className="flex items-center gap-1">
                <span className={`w-[6px] h-[6px] rounded-full ${isOnline ? 'bg-green-500' : 'bg-white/20'}`} />
                <span className="font-normal text-[10px] leading-none text-white/40">
