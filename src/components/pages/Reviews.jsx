...
const Reviews = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#F4F5F8] p-[24px]">
      {/* Header and Filters Section matching the Payments layout perfectly */}
      <div className="flex items-center justify-between mb-[18px]">
        <div>
          <div className="font-extrabold text-[22px] leading-none text-[#0A0A0F]">My Reviews</div>
          <div className="text-[14px] leading-none text-[#9090A0] mt-[4px]">
            847 total reviews · All from verified bookings
          </div>
        </div>
        <div className="flex gap-[9px]">
          <button className="px-[16px] py-[8px] bg-white border-[1.5px] border-[#EBEBEF] rounded-[9px] text-[12px] font-medium text-[#6B7280] hover:border-[#D61CA8] transition-colors">
            Service ▾
          </button>
          <button className="px-[16px] py-[8px] bg-white border-[1.5px] border-[#EBEBEF] rounded-[9px] text-[12px] font-medium text-[#6B7280] hover:border-[#D61CA8] transition-colors">
            Rating ▾
      ...
      {/* Summary Matrix Breakdown */}
      <div className="grid grid-cols-[180px_1fr] gap-[12px] mb-[18px]">
        <div className="bg-white rounded-[13px] p-[15px] shadow-[0_1px_4px_rgba(0,0,0,0.05)] text-center flex flex-col justify-center items-center">
        ...
        <div className="bg-white rounded-[13px] p-[15px] shadow-[0_1px_4px_rgba(0,0,0,0.05)] flex flex-col justify-center">
