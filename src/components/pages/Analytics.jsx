...
const Analytics = () => {
  return (
    <div className="flex-1 overflow-y-auto bg-[#F4F5F8] p-[24px]">
      {/* Header and Filter/Toggle Section matching layout standards perfectly */}
      <div className="flex items-center justify-between mb-[18px]">
        <div>
          <div className="font-extrabold text-[22px] leading-none text-[#0A0A0F]">Analytics</div>
          <div className="text-[14px] leading-none text-[#9090A0] mt-[4px]">
            AI-powered performance insights
          </div>
        </div>
        <div className="flex items-center gap-[9px]">
          <div className="flex items-center gap-1.5 bg-[#D61CA8]/5 border border-[#D61CA8]/15 rounded-full px-2.5 py-1.5">
            <span>✨</span>
              ...
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <div
                  className={`w-full rounded-t-[3px] ${
                    d.highlight ? 'bg-gradient-to-b from-[#4B6EF5] to-[#8B2EF5]' : 'bg-gradient-to-br from-[#D61CA8] to-[#8B2EF5]'
                  }`}
